...
VALUES (1, 1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 10 HOUR, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 12 HOUR, 10);
...
VALUES (1, 1, 1, 'COMPLETED', DATE_SUB(NOW(), INTERVAL 2 DAY), 50.00, 'ATTENDED', 5, '本地演示评价', DATE_SUB(NOW(), INTERVAL 1 DAY));
