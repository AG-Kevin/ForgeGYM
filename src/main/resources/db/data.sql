...
INSERT IGNORE INTO course_schedule (id, course_id, coach_id, store_id, start_time, end_time, capacity)
VALUES 
(6, 6, 7, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 18 HOUR, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 19 HOUR + INTERVAL 30 MINUTE, 15),
(7, 7, 6, 4, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 10 HOUR, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 11 HOUR, 1), -- 1对1 只有1个名额
(8, 8, 8, 4, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 20 HOUR, 30),
(9, 9, 5, 3, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 12 HOUR, DATE_ADD(CURDATE(), INTERVAL 2 DAY) + INTERVAL 12 HOUR + INTERVAL 45 MINUTE, 20),
(10, 1, 1, 1, DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 10 HOUR, DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 11 HOUR, 10),
(11, 2, 2, 2, DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 14 HOUR, DATE_ADD(CURDATE(), INTERVAL 4 DAY) + INTERVAL 15 HOUR, 15),
(12, 3, 5, 1, DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 16 HOUR, DATE_ADD(CURDATE(), INTERVAL 5 DAY) + INTERVAL 17 HOUR, 1),
(13, 6, 7, 4, DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 19 HOUR, DATE_ADD(CURDATE(), INTERVAL 6 DAY) + INTERVAL 20 HOUR + INTERVAL 30 MINUTE, 12),
(14, 8, 8, 1, DATE_ADD(CURDATE(), INTERVAL 7 DAY) + INTERVAL 10 HOUR, DATE_ADD(CURDATE(), INTERVAL 7 DAY) + INTERVAL 11 HOUR, 20),
(15, 7, 6, 1, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 14 HOUR, DATE_ADD(CURDATE(), INTERVAL 1 DAY) + INTERVAL 15 HOUR, 2); -- 满员测试
